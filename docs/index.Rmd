...
# Posible list to import to ADAGIO
```{r}
datatable(w %>% 
  group_by(Country, Country_ISO, VectorSpecies, year, VBD_Agent, VBD_Agent_subtype, VBD_AS_Full, MIR) %>% 
  summarise(n()))

# NUTS2,"VectorSpeciesName","latest","status_numeric","NUTS_published_year","Status"
